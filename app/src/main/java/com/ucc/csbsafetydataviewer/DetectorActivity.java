...
import com.ucc.csbsafetydataviewer.customview.OverlayView;
import com.ucc.csbsafetydataviewer.customview.OverlayView.DrawCallback;
import com.ucc.csbsafetydataviewer.env.BorderedText;
import com.ucc.csbsafetydataviewer.env.ImageUtils;
import com.ucc.csbsafetydataviewer.env.Logger;
import com.ucc.csbsafetydataviewer.tflite.Classifier;
import com.ucc.csbsafetydataviewer.tflite.TFLiteObjectDetectionAPIModel;
import com.ucc.csbsafetydataviewer.tracking.MultiBoxTracker;
 ...
 * objects.
 */
public class DetectorActivity extends com.ucc.csbsafetydataviewer.CameraActivity implements OnImageAvailableListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    //startActivity(new Intent(this,dataViewer.class));
        ...
        if (resultsAux.size() > 0) {
          ...
          if (conf >= 0.6f) {
            ...
            if (result.getId().equals("0")) {
              color = Color.GREEN;
              mDatabase.child("establishment/maskChecker").child("hasMask").setValue("true");
            }
            else {
              color = Color.RED;
              mDatabase.child("establishment/maskChecker").child("hasMask").setValue("false");
              removeUserData();
            }
          }
...
//    }
  ...
  private void removeUserData() {
    ...
    DatabaseReference mDatabase2 = FirebaseDatabase.getInstance().getReference("userTemp/Temp");

...
public abstract class CameraActivity extends AppCompatActivity
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        final MediaPlayer beep = MediaPlayer.create(CameraActivity.this, R.raw.beep);
        final MediaPlayer TempTooHigh = MediaPlayer.create(CameraActivity.this, R.raw.temptoohighvoice);
        final MediaPlayer NormalTemp = MediaPlayer.create(CameraActivity.this, R.raw.normaltemp);
...
//        }
    ...
    protected void setFragment() {
        ...
        Fragment fragment;
        if (useCamera2API) {
            com.ucc.csbsafetydataviewer.CameraConnectionFragment camera2Fragment =
                    com.ucc.csbsafetydataviewer.CameraConnectionFragment.newInstance(
                            new com.ucc.csbsafetydataviewer.CameraConnectionFragment.ConnectionCallback() {
                                @Override
                                public void onPreviewSizeChosen(final Size size, final int rotation) {
                                    previewHeight = size.getHeight();
                                    previewWidth = size.getWidth();
                                    com.ucc.csbsafetydataviewer.CameraActivity.this.onPreviewSizeChosen(size, rotation);
                                }
                            },
                            this,
                            getLayoutId(),
    ...
    private void checkUserStatus(MediaPlayer beep, MediaPlayer TempTooHigh,MediaPlayer NormalTemp) {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                String tmp = String.valueOf(dataSnapshot.child("Temp").getValue());
                double userTemp = 0.0;
                if (!tmp.equals("null"))
                    userTemp = Double.valueOf(tmp);
